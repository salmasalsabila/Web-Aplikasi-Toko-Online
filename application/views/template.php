  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('index.php/buku/dashboard')?>" class="logo"><b>EShoper</b></a>
            <!--logo end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?=base_url('index.php/Buku')?>">Daftar Buku</a></li>
                          <li><a  href="<?=base_url('index.php/Kategori')?>">Kategori</a></li>
                      </ul>
                  </li>
                  <?php elseif($this->session->userdata('jabatan')=="kasir"):?>
                  <li class="sub-menu">
