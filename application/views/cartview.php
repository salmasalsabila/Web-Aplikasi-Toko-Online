					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">					
								<li><a href="<?=base_url('Home/checkout')?>"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								<li><a href="<?=base_url('Home/cart')?>" class="active"><i class="fa fa-shopping-cart"></i> Cart</a></li>
							</ul>
						</div>
					</div>
				</div>
