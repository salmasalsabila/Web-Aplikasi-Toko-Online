...
<div class="col-md-6">
	<table id="example" class="table table-hover table-striped">
		...
		<tbody>
			<?php $no=0; foreach($tampil_buku as $skincare): $no++; ?>
			<tr>
				<td><?=$no?></td>
				...
				<?php if($skincare->stok>0): ?>
				<td><a href="<?=base_url('index.php/transaksi/addcart/'.$skincare->id_skincare)?>" class="btn btn-info">Pesan</a></td>
